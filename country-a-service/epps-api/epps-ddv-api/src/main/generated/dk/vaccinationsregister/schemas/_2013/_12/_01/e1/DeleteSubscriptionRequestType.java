...
/**
 * <p>Java class for DeleteSubscriptionRequestType complex type.
 * 
...
@XmlType(name = "DeleteSubscriptionRequestType", propOrder = {
    "personCivilRegistrationIdentifier",
    "modified",
    "reported",
    "deleteSubscription"
})
public class DeleteSubscriptionRequestType {
    ...
    @XmlElement(name = "DeleteSubscription", required = true)
     ...
     */
    public<_B >void copyTo(final DeleteSubscriptionRequestType.Builder<_B> _other) {
    ...
    public<_B >DeleteSubscriptionRequestType.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new DeleteSubscriptionRequestType.Builder<_B>(_parentBuilder, this, true);
    }

    public DeleteSubscriptionRequestType.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static DeleteSubscriptionRequestType.Builder<Void> builder() {
        return new DeleteSubscriptionRequestType.Builder<>(null, null, false);
    }

    public static<_B >DeleteSubscriptionRequestType.Builder<_B> copyOf(final DeleteSubscriptionRequestType _other) {
        final DeleteSubscriptionRequestType.Builder<_B> _newBuilder = new DeleteSubscriptionRequestType.Builder<>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final DeleteSubscriptionRequestType.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    ...
    public<_B >DeleteSubscriptionRequestType.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new DeleteSubscriptionRequestType.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public DeleteSubscriptionRequestType.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >DeleteSubscriptionRequestType.Builder<_B> copyOf(final DeleteSubscriptionRequestType _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final DeleteSubscriptionRequestType.Builder<_B> _newBuilder = new DeleteSubscriptionRequestType.Builder<>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static DeleteSubscriptionRequestType.Builder<Void> copyExcept(final DeleteSubscriptionRequestType _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static DeleteSubscriptionRequestType.Builder<Void> copyOnly(final DeleteSubscriptionRequestType _other, final PropertyTree _propertyTree) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final DeleteSubscriptionRequestType _storedValue;
        private String personCivilRegistrationIdentifier;
        private ModifiedType.Builder<DeleteSubscriptionRequestType.Builder<_B>> modified;
        private ModifiedType.Builder<DeleteSubscriptionRequestType.Builder<_B>> reported;
        private DeleteSubscriptionType.Builder<DeleteSubscriptionRequestType.Builder<_B>> deleteSubscription;

        public Builder(final _B _parentBuilder, final DeleteSubscriptionRequestType _other, final boolean _copy) {
        ...
        public Builder(final _B _parentBuilder, final DeleteSubscriptionRequestType _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends DeleteSubscriptionRequestType >_P init(final _P _product) {
         ...
         */
        public DeleteSubscriptionRequestType.Builder<_B> withPersonCivilRegistrationIdentifier(final String personCivilRegistrationIdentifier) {
         ...
         */
        public DeleteSubscriptionRequestType.Builder<_B> withModified(final ModifiedType modified) {
         ...
         *     return to the current builder.
         */
        public ModifiedType.Builder<? extends DeleteSubscriptionRequestType.Builder<_B>> withModified() {
         ...
         */
        public DeleteSubscriptionRequestType.Builder<_B> withReported(final ModifiedType reported) {
         ...
         *     return to the current builder.
         */
        public ModifiedType.Builder<? extends DeleteSubscriptionRequestType.Builder<_B>> withReported() {
         ...
         */
        public DeleteSubscriptionRequestType.Builder<_B> withDeleteSubscription(final DeleteSubscriptionType deleteSubscription) {
         ...
         *     to return to the current builder.
         */
        public DeleteSubscriptionType.Builder<? extends DeleteSubscriptionRequestType.Builder<_B>> withDeleteSubscription() {
        ...
        @Override
        public DeleteSubscriptionRequestType build() {
            if (_storedValue == null) {
                return this.init(new DeleteSubscriptionRequestType());
            } else {
                return ((DeleteSubscriptionRequestType) _storedValue);
            }
        }

        public DeleteSubscriptionRequestType.Builder<_B> copyOf(final DeleteSubscriptionRequestType _other) {
            _other.copyTo(this);
            return this;
        }

        public DeleteSubscriptionRequestType.Builder<_B> copyOf(final DeleteSubscriptionRequestType.Builder _other) {
    ...
    public static class Select
        extends DeleteSubscriptionRequestType.Selector<DeleteSubscriptionRequestType.Select, Void>
    {
        ...
        public static DeleteSubscriptionRequestType.Select _root() {
            return new DeleteSubscriptionRequestType.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private com.kscs.util.jaxb.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> personCivilRegistrationIdentifier = null;
        private ModifiedType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> modified = null;
        private ModifiedType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> reported = null;
        private DeleteSubscriptionType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> deleteSubscription = null;
        ...
        public com.kscs.util.jaxb.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> personCivilRegistrationIdentifier() {
        ...
        public ModifiedType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> modified() {
            return ((this.modified == null)?this.modified = new ModifiedType.Selector<>(this._root, this, "modified"):this.modified);
        }

        public ModifiedType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> reported() {
            return ((this.reported == null)?this.reported = new ModifiedType.Selector<>(this._root, this, "reported"):this.reported);
        }

        public DeleteSubscriptionType.Selector<TRoot, DeleteSubscriptionRequestType.Selector<TRoot, TParent>> deleteSubscription() {
