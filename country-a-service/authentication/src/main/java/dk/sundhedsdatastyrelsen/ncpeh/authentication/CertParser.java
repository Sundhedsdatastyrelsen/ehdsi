...
public class CertParser {
    ...
    public static String parse(String soapHeader) {
        try {
    ...
    private static String extractCertificateFromSoap(String soapXml) {
        try {
    ...
    private static String getCountryCodeFromCert(X509Certificate cert, String rdnType) {
        try {
