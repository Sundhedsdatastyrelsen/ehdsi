...
public class DeleteSubscriptionType {
     ...
     */
    public<_B >void copyTo(final DeleteSubscriptionType.Builder<_B> _other) {
    ...
    public<_B >DeleteSubscriptionType.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
        return new DeleteSubscriptionType.Builder<_B>(_parentBuilder, this, true);
    }

    public DeleteSubscriptionType.Builder<Void> newCopyBuilder() {
        return newCopyBuilder(null);
    }

    public static DeleteSubscriptionType.Builder<Void> builder() {
        return new DeleteSubscriptionType.Builder<>(null, null, false);
    }

    public static<_B >DeleteSubscriptionType.Builder<_B> copyOf(final DeleteSubscriptionType _other) {
        final DeleteSubscriptionType.Builder<_B> _newBuilder = new DeleteSubscriptionType.Builder<>(null, null, false);
     ...
     *     A builder instance to which the state of this object will be copied.
     */
    public<_B >void copyTo(final DeleteSubscriptionType.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
    ...
    public<_B >DeleteSubscriptionType.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return new DeleteSubscriptionType.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
    }

    public DeleteSubscriptionType.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
    }

    public static<_B >DeleteSubscriptionType.Builder<_B> copyOf(final DeleteSubscriptionType _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
        final DeleteSubscriptionType.Builder<_B> _newBuilder = new DeleteSubscriptionType.Builder<>(null, null, false);
        _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
        return _newBuilder;
    }

    public static DeleteSubscriptionType.Builder<Void> copyExcept(final DeleteSubscriptionType _other, final PropertyTree _propertyTree) {
        return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
    }

    public static DeleteSubscriptionType.Builder<Void> copyOnly(final DeleteSubscriptionType _other, final PropertyTree _propertyTree) {
    ...
    public static class Builder<_B >implements Buildable
    {
        ...
        protected final DeleteSubscriptionType _storedValue;
        private PersonVaccinationPlanType.Builder<DeleteSubscriptionType.Builder<_B>> personVaccinationPlan;
        private String status;

        public Builder(final _B _parentBuilder, final DeleteSubscriptionType _other, final boolean _copy) {
        ...
        public Builder(final _B _parentBuilder, final DeleteSubscriptionType _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
            this._parentBuilder = _parentBuilder;
            if (_other!= null) {
                if (_copy) {
                    _storedValue = null;
        ...
        protected<_P extends DeleteSubscriptionType >_P init(final _P _product) {
         ...
         */
        public DeleteSubscriptionType.Builder<_B> withPersonVaccinationPlan(final PersonVaccinationPlanType personVaccinationPlan) {
         ...
         *     to return to the current builder.
         */
        public PersonVaccinationPlanType.Builder<? extends DeleteSubscriptionType.Builder<_B>> withPersonVaccinationPlan() {
         ...
         */
        public DeleteSubscriptionType.Builder<_B> withStatus(final String status) {
            this.status = status;
            return this;
        }

        @Override
        public DeleteSubscriptionType build() {
            if (_storedValue == null) {
                return this.init(new DeleteSubscriptionType());
            } else {
                return ((DeleteSubscriptionType) _storedValue);
            }
        }

        public DeleteSubscriptionType.Builder<_B> copyOf(final DeleteSubscriptionType _other) {
            _other.copyTo(this);
            return this;
        }

        public DeleteSubscriptionType.Builder<_B> copyOf(final DeleteSubscriptionType.Builder _other) {
    ...
    public static class Select
        extends DeleteSubscriptionType.Selector<DeleteSubscriptionType.Select, Void>
    {
        ...
        public static DeleteSubscriptionType.Select _root() {
            return new DeleteSubscriptionType.Select();
        }
        ...
        extends com.kscs.util.jaxb.Selector<TRoot, TParent>
    {
        ...
        private PersonVaccinationPlanType.Selector<TRoot, DeleteSubscriptionType.Selector<TRoot, TParent>> personVaccinationPlan = null;
        private com.kscs.util.jaxb.Selector<TRoot, DeleteSubscriptionType.Selector<TRoot, TParent>> status = null;
        ...
        public PersonVaccinationPlanType.Selector<TRoot, DeleteSubscriptionType.Selector<TRoot, TParent>> personVaccinationPlan() {
        ...
        public com.kscs.util.jaxb.Selector<TRoot, DeleteSubscriptionType.Selector<TRoot, TParent>> status() {
