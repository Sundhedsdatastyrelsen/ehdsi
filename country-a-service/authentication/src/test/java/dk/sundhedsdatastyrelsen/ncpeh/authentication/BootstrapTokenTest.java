    ...
    void fromHcpAssertion() throws Exception {
        ...
        assertThat(
            xml, stringContainsInOrder(
                ...
                "<wst13:RequestType>http://docs.oasis-open.org/ws-sx/ws-trust/200512/Issue</wst13:RequestType>",
                "<saml:Audience>https://fmk</saml:Audience>",
                "<saml:Attribute FriendlyName=\"XUA Patient Id\" Name=\"urn:oasis:names:tc:xacml:2.0:resource:resource-id\">" +
                    "<saml:AttributeValue xsi:type=\"xsd:string\">1011649927^^^&amp;1.2.208.176.1.2&amp;ISO</saml:AttributeValue>" +
                    "</saml:Attribute>",
                "<saml:Attribute FriendlyName=\"EHDSI Country of Treatment\" Name=\"urn:dk:healthcare:saml:CountryOfTreatment\">" +
                    "<saml:AttributeValue xsi:type=\"xsd:string\">DK</saml:AttributeValue>" +
                    "</saml:Attribute>"
            ));

        assertThat(
            "The Role element needs to be transformed to include an xsi:type attribute, to workaround a SOSI bug",
            xml,
            containsString("<Role xmlns=\"urn:hl7-org:v3\" code=\"221\" codeSystem=\"2.16.840.1.113883.2.9.6.2.7\" codeSystemName=\"ISCO\" displayName=\"Medical Doctors\" xsi:type=\"CE\"/>"));

        assertThat(
            "The PurposeOfUse element needs to be transformed to include an xsi:type attribute, to workaround a SOSI bug," +
                "and to use another code system to work around another bug",
            xml,
            containsString("""
