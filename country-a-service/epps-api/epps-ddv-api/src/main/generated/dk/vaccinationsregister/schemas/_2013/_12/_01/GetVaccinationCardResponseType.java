...
/**
* <p>Java class for GetVaccinationCardResponseType complex type.
* 
...
@XmlType(name = "GetVaccinationCardResponseType", propOrder = {
 "vaccination",
 "negativeConsentStructure"
})
public class GetVaccinationCardResponseType {
 ...
 */
 public<_B >void copyTo(final GetVaccinationCardResponseType.Builder<_B> _other) {
 ...
 _other.negativeConsentStructure = ((this.negativeConsentStructure == null)?null:this.negativeConsentStructure.newCopyBuilder(_other));
  ...
  public<_B >GetVaccinationCardResponseType.Builder<_B> newCopyBuilder(final _B _parentBuilder) {
 return new GetVaccinationCardResponseType.Builder<_B>(_parentBuilder, this, true);
 }
  public GetVaccinationCardResponseType.Builder<Void> newCopyBuilder() {
 return newCopyBuilder(null);
 }
  public static GetVaccinationCardResponseType.Builder<Void> builder() {
 return new GetVaccinationCardResponseType.Builder<>(null, null, false);
 }
  public static<_B >GetVaccinationCardResponseType.Builder<_B> copyOf(final GetVaccinationCardResponseType _other) {
 final GetVaccinationCardResponseType.Builder<_B> _newBuilder = new GetVaccinationCardResponseType.Builder<>(null, null, false);
 ...
 *     A builder instance to which the state of this object will be copied.
 */
 public<_B >void copyTo(final GetVaccinationCardResponseType.Builder<_B> _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
 ...
 if (((_propertyTreeUse == PropertyTreeUse.INCLUDE)?(negativeConsentStructurePropertyTree!= null):((negativeConsentStructurePropertyTree == null)||(!negativeConsentStructurePropertyTree.isLeaf())))) {
  ...
  public<_B >GetVaccinationCardResponseType.Builder<_B> newCopyBuilder(final _B _parentBuilder, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
 return new GetVaccinationCardResponseType.Builder<_B>(_parentBuilder, this, true, _propertyTree, _propertyTreeUse);
 }
  public GetVaccinationCardResponseType.Builder<Void> newCopyBuilder(final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
 return newCopyBuilder(null, _propertyTree, _propertyTreeUse);
 }
  public static<_B >GetVaccinationCardResponseType.Builder<_B> copyOf(final GetVaccinationCardResponseType _other, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
 final GetVaccinationCardResponseType.Builder<_B> _newBuilder = new GetVaccinationCardResponseType.Builder<>(null, null, false);
 _other.copyTo(_newBuilder, _propertyTree, _propertyTreeUse);
 return _newBuilder;
 }
  public static GetVaccinationCardResponseType.Builder<Void> copyExcept(final GetVaccinationCardResponseType _other, final PropertyTree _propertyTree) {
 return copyOf(_other, _propertyTree, PropertyTreeUse.EXCLUDE);
 }
  public static GetVaccinationCardResponseType.Builder<Void> copyOnly(final GetVaccinationCardResponseType _other, final PropertyTree _propertyTree) {
 return copyOf(_other, _propertyTree, PropertyTreeUse.INCLUDE);
 }
  public static class Builder<_B >implements Buildable
 {
  protected final _B _parentBuilder;
 protected final GetVaccinationCardResponseType _storedValue;
 private List<VaccinationType.Builder<GetVaccinationCardResponseType.Builder<_B>>> vaccination;
 private NegativeConsentStructureType.Builder<GetVaccinationCardResponseType.Builder<_B>> negativeConsentStructure;
  public Builder(final _B _parentBuilder, final GetVaccinationCardResponseType _other, final boolean _copy) {
  ...
  public Builder(final _B _parentBuilder, final GetVaccinationCardResponseType _other, final boolean _copy, final PropertyTree _propertyTree, final PropertyTreeUse _propertyTreeUse) {
  this._parentBuilder = _parentBuilder;
  if (_other!= null) {
   if (_copy) {
     _storedValue = null;
  ...
  protected<_P extends GetVaccinationCardResponseType >_P init(final _P _product) {
  if (this.vaccination!= null) {
   final List<VaccinationType> vaccination = new ArrayList<>(this.vaccination.size());
   for (VaccinationType.Builder<GetVaccinationCardResponseType.Builder<_B>> _item: this.vaccination) {
 ...
 */
 public GetVaccinationCardResponseType.Builder<_B> addVaccination(final Iterable<? extends VaccinationType> vaccination) {
  if (vaccination!= null) {
   if (this.vaccination == null) {
     this.vaccination = new ArrayList<>();
   }
 ...
 */
 public GetVaccinationCardResponseType.Builder<_B> withVaccination(final Iterable<? extends VaccinationType> vaccination) {
  if (this.vaccination!= null) {
 ...
 *     Items to add to the value of the "vaccination" property
 */
 public GetVaccinationCardResponseType.Builder<_B> addVaccination(VaccinationType... vaccination) {
 ...
 *     New value of the "vaccination" property.
 */
 public GetVaccinationCardResponseType.Builder<_B> withVaccination(VaccinationType... vaccination) {
 ...
 *     return to the current builder.
 */
 public VaccinationType.Builder<? extends GetVaccinationCardResponseType.Builder<_B>> addVaccination() {
  if (this.vaccination == null) {
   this.vaccination = new ArrayList<>();
  }
  final VaccinationType.Builder<GetVaccinationCardResponseType.Builder<_B>> vaccination_Builder = new VaccinationType.Builder<>(this, null, false);
 ...
 */
 public GetVaccinationCardResponseType.Builder<_B> withNegativeConsentStructure(final NegativeConsentStructureType negativeConsentStructure) {
 ...
 *     to return to the current builder.
 */
 public NegativeConsentStructureType.Builder<? extends GetVaccinationCardResponseType.Builder<_B>> withNegativeConsentStructure() {
  ...
  @Override
 public GetVaccinationCardResponseType build() {
  if (_storedValue == null) {
   return this.init(new GetVaccinationCardResponseType());
  } else {
   return ((GetVaccinationCardResponseType) _storedValue);
  }
 }
  public GetVaccinationCardResponseType.Builder<_B> copyOf(final GetVaccinationCardResponseType _other) {
  _other.copyTo(this);
  return this;
 }
  public GetVaccinationCardResponseType.Builder<_B> copyOf(final GetVaccinationCardResponseType.Builder _other) {
  return copyOf(_other.build());
 }
  }
  public static class Select
 extends GetVaccinationCardResponseType.Selector<GetVaccinationCardResponseType.Select, Void>
 {
   Select() {
  super(null, null, null);
 }
  public static GetVaccinationCardResponseType.Select _root() {
  return new GetVaccinationCardResponseType.Select();
 }
  }
  public static class Selector<TRoot extends com.kscs.util.jaxb.Selector<TRoot, ?> , TParent >
 extends com.kscs.util.jaxb.Selector<TRoot, TParent>
 {
  private VaccinationType.Selector<TRoot, GetVaccinationCardResponseType.Selector<TRoot, TParent>> vaccination = null;
 private NegativeConsentStructureType.Selector<TRoot, GetVaccinationCardResponseType.Selector<TRoot, TParent>> negativeConsentStructure = null;
 ...
 public Map<String, PropertyTree> buildChildren() {
  ...
  public VaccinationType.Selector<TRoot, GetVaccinationCardResponseType.Selector<TRoot, TParent>> vaccination() {
  return ((this.vaccination == null)?this.vaccination = new VaccinationType.Selector<>(this._root, this, "vaccination"):this.vaccination);
 }
  public NegativeConsentStructureType.Selector<TRoot, GetVaccinationCardResponseType.Selector<TRoot, TParent>> negativeConsentStructure() {
