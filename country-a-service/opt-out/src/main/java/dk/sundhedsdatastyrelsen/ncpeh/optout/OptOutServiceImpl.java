...
public class OptOutServiceImpl implements OptOutService, AutoCloseable {
    ...
    private HashMap<Service, Boolean> lookup(Request request) throws IOException, InterruptedException {
        ...
        if (resp.statusCode() != 200) {
            throw new RuntimeException("Bad response from opt-out lookup service. Response code: %s. Body: %s".formatted(resp.statusCode(), resp.body()));
        }
    ...
    public static void main(String... args) throws Exception {
        var oo = new OptOutServiceImpl(new Config(
            ...
            "/Users/hansbugge/gtsrc/sds/ehdsi/country-a-service/opt-out/src/test/resources/opt-out-keystore.p12",
            "changeit",
            "/Users/hansbugge/gtsrc/sds/ehdsi/country-a-service/opt-out/src/test/resources/opt-out-truststore.p12",
            "changeit"));
