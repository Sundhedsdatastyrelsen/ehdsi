...
export SC_KEYSTORE_PASSWORD; SC_KEYSTORE_PASSWORD="$(cat "${SC_KEYSTORE_PASSWORD_FILE}")"
export SC_SMP_CLIENT_PRIVATEKEY_PASSWORD; SC_SMP_CLIENT_PRIVATEKEY_PASSWORD="$(cat "${SC_SMP_CLIENT_PRIVATEKEY_PASSWORD_FILE}")"
