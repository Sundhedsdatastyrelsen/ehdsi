...
public class XPathWrapper {
     ...
     * @throws XmlException if the expression cannot be evaluated by XPath
     */
    public String evalString(String expression, Object item) {
        try {
            return xpath().evaluate(expression, item).trim();
        } catch (XPathExpressionException e) {
            throw new XmlException("Xpath invalid", e);
        }
    }
     ...
     * @throws XmlException if the expression cannot be evaluated by XPath
     */
    public Node evalNode(String expression, Object item) {
        try {
     ...
     * @throws XmlException if the expression cannot be evaluated by XPath
     */
    public Element evalElement(String expression, Object item) {
     ...
     * @throws XmlException if the expression cannot be evaluated by XPath
     */
    public List<Node> evalNodes(String expression, Object item) {
        try {
     ...
     * @throws XmlException if the expression cannot be evaluated by XPath
     */
    public List<String> evalStrings(String expression, Object item) {
