...
public class XmlUtils {
     ...
     */
    public static Element appendChild(Document parent, XmlNamespaceContract ns, String name) {
     ...
     * @return the created Element
     */
    public static Element appendChild(Element parent, XmlNamespaceContract ns, String name) {
     ...
     * @return the created Element
     */
    public static Element appendChild(Element parent, XmlNamespaceContract ns, String name, String textValue) {
        var child = parent.getOwnerDocument().createElementNS(ns.uri(), name);
        child.setPrefix(ns.prefix());
     ...
     */
    public static void declareNamespaces(Element element, XmlNamespaceContract... namespaces) {
     ...
     */
    public static void setIdAttribute(Element elm, XmlNamespaceContract ns, String name, String value) {
     ...
     * @param value     the attribute value
     */
    public static void setAttribute(Element elm, XmlNamespaceContract ns, String localName, String value) {
