...
public class NspClientIdws {
    ...
    ///
    /// @throws NspClientException if the request fails
    public static Element request(
        ...
        try (var httpClient = HttpClient.newBuilder().build()) {
            ...
            throw new NspClientException("Error when calling NSP service with action " + soapAction, e);
    ...
    private static Document createEnvelope(Element soapBody, String soapAction, EuropeanHcpIdwsToken token, PrivateKey signingKey, Element[] extraHeaders) {
        try {
            // Structure
        ...
        } catch (XMLSignatureException | MarshalException | NoSuchAlgorithmException |
                 InvalidAlgorithmParameterException e) {
            throw new NspClientException("Failed to create envelope", e);
        }
    }
