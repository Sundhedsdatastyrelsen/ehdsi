            ...
            return result.stream()
                .map(md -> DocumentFactory.createDocumentAssociation(
                    DocumentFactory.createEPDocumentXML(
                        ...
                        new EpListParam(md.getLevel3().getDispensable(),md.getLevel3().getAtcCode(),md.getLevel3().getAtcName(),md.getLevel3().getDoseFormCode(),md.getLevel3().getDoseFormName(),md.getLevel3().getStrength(),new SubstitutionMetadata(md.getLevel3().getSubstitutionCode(),md.getLevel1().getSubstitutionDisplayName())),
                    ...
                    DocumentFactory.createEPDocumentPDF(
                        ...
                        new EpListParam(md.getLevel1().getDispensable(),md.getLevel1().getAtcCode(),md.getLevel1().getAtcName(),md.getLevel1().getDoseFormCode(),md.getLevel1().getDoseFormName(),md.getLevel1().getStrength(),new SubstitutionMetadata(md.getLevel1().getSubstitutionCode(),md.getLevel1().getSubstitutionDisplayName())),
